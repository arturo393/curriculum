# Arturo Veras Olivos
**Senior IoT Engineer & Embedded Systems Specialist**

📍 Santiago, Chile | 📞 +56 9 82413883 | ✉️ a.veras@gmail.com
🏆 9+ años de experiencia en desarrollo tecnológico

---

## 💼 PERFIL PROFESIONAL

Ingeniero Civil Electrónico con **9+ años de experiencia** desarrollando soluciones tecnológicas end-to-end, desde hardware embebido hasta aplicaciones empresariales. Especialista en **sistemas IoT críticos** y **firmware para microcontroladores STM32**, con experiencia comprobada en entornos industriales extremos.
...
C/C++ • FreeRTOS • Google Cloud • Docker

### Herramientas y Metodologías
Git • Linux • Instrumentación RF
...
### **Sistema IoT Industrial - Minería Subterránea**
...
• **Ganador I+D Aplicada** - Proyecto HH Motors, Fundación Copec UC (2015)
