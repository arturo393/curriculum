...
\cventry{2 years 11 months / Agosto 2021 - Present}{AI-Augmented Staff Engineer \& I+D Tech Lead}{Uqomm 
 (\url{www.uqomm.com})}{Con Con, Chile}{}{
Head of the Software R\&D department, leading a team of 3 engineers. Responsible for the architectural design and deployment of highly resilient embedded systems and distributed networks.
\begin{itemize}
    \item \textbf{Firmware (C/Rust):} Lead developer of \textit{fw-diagnostico-remoto-vlad} and \textit{sigmavpn}, managing LoRa frequencies, FSK TX modules, UART routing, and granular bitmask logging for memory-constrained Cortex-M0 devices.
    \item \textbf{AI Orchestration (Python/JS):} Engineered custom AI-Agent protocols (\textit{dev-agents}) enforcing C++20 standards and MISRA-C rules. Developed \textit{uqomm-googlesheet-mcp-server} to link AI agents with internal processes.
    \item \textbf{AIOps \& QA Automation:} Architected \textit{sw-testbench-orchestrator} (Test-Driven Development), pushing automated hardware validations and multiplying team delivery velocity by 10x through advanced Prompt Engineering and automated QA pipelines.
\end{itemize}
}
...
\section{Key Open Source \& Deep Tech Projects}
\cventry{2025 - Present}{Advanced Algorithmic Research}{monteCarlo}{}{}{
Developed a high-performance simulation engine implementing Monte Carlo Tree Search (MCTS), Markov Chain Monte Carlo (MCMC), and Particle Swarm Optimization (PSO). Integrated an MCP Server to fully automate GitHub issue tracking via LLMs, showcasing cutting-edge Machine Learning Engineering.
}

\cventry{2025 - Present}{AI Governance Framework}{dev-agents}{}{}{
Created a master "Constitution" repository serving as the brain for AI agents (Copilot/Cursor). It enforces strict YAML frontmatter rules, layer architecture, and memory safety directives for C++ firmware, turning junior-level AI outputs into Staff-level enterprise code.
}
