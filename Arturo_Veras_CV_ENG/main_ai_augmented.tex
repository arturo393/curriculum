...
\cventry{2 years  11 months /  Agosto 2021 - Present}{AI-Augmented Staff Engineer \& Systems Architect}{Uqomm 
 (\url{www.uqomm.com})}{Con Con, Chile}{}{
Lead the architectural design and deployment of highly resilient embedded systems and distributed networks. Engineered custom AI-Agent protocols (dev-agents) that act as a centralized knowledge base, enforcing C++20 standards, memory safety rules, and layered architecture constraints across all generated code. Reduced critical firmware bugs by strictly enforcing Tier-1 Compile-Time Assertions and Off-Target Host Unit Tests in the CI/CD pipeline. Directed the transition from manual coding to AI-orchestrated development, focusing human effort on architectural review, security auditing, and threat modeling.
}
